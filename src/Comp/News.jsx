...
export class News extends Component {
    ...
    let url = `http://65.0.181.76:8080/get-news?country=${this.props.country}&category=${this.props.category}&page=1&pageSize=${this.props.pageSize}`;
    ...
    let url = `http://65.0.181.76:8080/get-news?country=${this.props.country}&category=${this.props.category}&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
